...
+ 3 phần chính và 1 engine để liên kết chúng
+nếu ko có nền tảng tổ chức sẽ khó hiểu...
+ vừa dễ hiểu vừa là nguyên tắc của hướng đối tượng dễ chỉnh sửa, thay đổi*/
...
+Các tải từ tệp rabbit-trap.html . Gói tất cả mọi thứ trong main vào listener
+Để đảm bảo các mã này không chạy sau khi cái này được tải lên */
